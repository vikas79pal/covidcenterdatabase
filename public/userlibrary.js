...
// console.log((document.getElementById('tb').children[0].children[ 1+ 1].children[0].textContent))
    ...
    for (let i = 1; i < document.getElementById('tb').children[0].children.length; i++) {
        if ((document.getElementById('tb').children[0].children[i].children[2].textContent.toLowerCase()).indexOf(searchf.value.toLowerCase()) > -1) {
